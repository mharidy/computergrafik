...
public class Vec3 {
	...
	/**
	 * Multiplies the given vectors component-wise and returns a newly allocated
	 * result vector.
	 */
	...
	public static final Vec3 grayH = vec3(0.5, 0.3, 0.5);
	public static final Vec3 red = vec3(1, 0, 0);
	public static final Vec3 green = vec3(0, 1, 0);
	public static final Vec3 darkgreen = vec3(0, 0.5, 0);
	public static final Vec3 blue = vec3(0, 0, 1);
	public static final Vec3 yellow = vec3(1, 1, 0);
	public static final Vec3 purple = vec3(0.5, 0, 1);
	public static final Vec3 orange = vec3(1, 0.5, 0);
	public static final Vec3 darkbrown = vec3(0.33, 0.21, 0.08);
	public static final Vec3 cyan = vec3(0, 1, 1);
	public static final Vec3 yellowSun = vec3(252, 212, 64);
	public static final Vec3 burningRed = vec3(174, 31, 35);
	public static final Vec3 samawey = vec3(35,212,226);


    public static final Vec3 bg = vec3(0.690, 0.819, 0.949);
    public static final Vec3 pred = vec3(0.839, 0.443, 0.474);
    public static final Vec3 porange = vec3(0.839, 0.658, 0.443);
    public static final Vec3 pyellow = vec3(0.827, 0.839, 0.443);
    public static final Vec3 pgreen = vec3(0.509, 0.839, 0.443);
    public static final Vec3 pblue = vec3(0.443, 0.705, 0.839);
    public static final Vec3 pbabyblue = vec3(0.443, 0.839, 0.741);
    public static final Vec3 ppurple = vec3(0.721, 0.443, 0.839);
    public static final Vec3 ppink = vec3(0.839, 0.443, 0.756);
