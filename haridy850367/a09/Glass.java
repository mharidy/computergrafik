...
public class Glass implements Material {
	...
	public Ray scatteredRay(Ray r, Hit h) {
		...
		Ray ray = new Ray(h.hitpoint, scat, 0.0001, Double.POSITIVE_INFINITY);
		return ray;
	}
	...
	public Ray reflect(Ray r, Hit h) {
		Vec3 re = subtract(normalize(r.normalizedDir),
				multiply(2 * dotProduct(normalize(h.normal), normalize(r.normalizedDir)), normalize(h.normal)));
