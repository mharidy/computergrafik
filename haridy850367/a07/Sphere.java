...
public class Sphere implements Shape{
    ...
    public Hit intersect(Ray r) {
        ...
        if (Double.isNaN(sqrt)) return new Hit(-1, null, null, material);
		...
		*/
        ...
        if (t1 > 0 && t2 < 0) strahlParameter = t1;
        if (t2 > 0 && t1 < 0) strahlParameter = t2;
        else strahlParameter = Math.min(t1, t2);
