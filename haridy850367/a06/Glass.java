...
public class Glass implements Material {
	...
	private final double indexL = 1.0;
	...
	public Ray scatteredRay(Ray r, Hit h) {
		...
		if (refract(r.dir, n, n1, n2) != null) {
			if (Random.random() > schlick(r.dir, n, n1, n2)) {
				scat = refract(r.dir, n, n1, n2);
			} else {
				temp = reflect(r, h);
				return temp;
			}
	...
	public Ray reflect(Ray r, Hit h) {
		Vec3 re = subtract(normalize(r.dir),
				multiply(2 * dotProduct(normalize(h.normal), normalize(r.dir)), normalize(h.normal)));
